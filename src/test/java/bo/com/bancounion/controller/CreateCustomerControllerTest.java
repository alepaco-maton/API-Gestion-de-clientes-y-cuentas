...
public class CreateCustomerControllerTest {
    ...
    public CreateCustomerControllerTest() {
    }
    ...
    @Test
    public void createFailNameRequiredNull() throws Exception {
    ...
    @Test
    public void createFailNameRequiredEmpty() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("");
        request.setPaternal(null);
        request.setMaternal(null);
    ...
    @Test
    public void createFailNameRequiredWithSpace() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("  ");
        request.setPaternal(null);
        request.setMaternal(null);
    ...
    @Test
    public void createFailNameInvalidMaxLength() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
    ...
    @Test
    public void createFailPaternalOrMaternalRequired() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
    ...
    @Test
    public void createFailPaternalInvalidMaxLength() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
    ...
    @Test
    public void createFailMaternalInvalidMaxLength() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
        request.setPaternal(null);
    ...
    @Test
    public void createFailDocumentTypeIdRequired() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
    ...
    @Test
    public void createFailDocumentTypeIdInvalidIdNotFound() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
        request.setPaternal("Paco");
        request.setMaternal("Surco");
    ...
    @Test
    public void createFailIdentityDocumentRequired() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
        request.setPaternal("Paco");
        request.setMaternal("Surco");
    ...
    @Test
    public void createFailIdentityDocumentInvalidMinLength() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
        request.setPaternal("Paco");
        request.setMaternal("Surco");
    ...
    @Test
    public void createFailIdentityDocumentInvalidMaxLength() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
        request.setPaternal("Paco");
        request.setMaternal("Surco");
    ...
    @Test
    public void createFailBirthDateRequired() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
        request.setPaternal("Paco");
        request.setMaternal("Surco");
    ...
    @Test
    public void createFailBirthDateInvalidLess18YearOlds() throws Exception {
        calendar.setTime(new Date());
    ...
    @Test
    public void createFailBirthDateInvalidCannotBeInTheFuture() throws Exception {
        calendar.setTime(new Date());
    ...
    @Test
    @Transactional
    public void createSuccessfulWithOnlyPaternalAndMaternalNull() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
        request.setPaternal("Paco");
        request.setMaternal(null);
    ...
    @Test
    @Transactional
    public void createSuccessfulWithOnlyMaternalAndPaternalNull() throws Exception {
        CreateUpdateCustomerRequest request = new CreateUpdateCustomerRequest();
        request.setName("Alex " + UUID.randomUUID().toString());
        request.setPaternal(null);
        request.setMaternal("Surco");
