...
public class ReadGenderControllerTest {
    ...
    public ReadGenderControllerTest() {
    }
    ...
    public void readSuccessful() throws Exception {
        ...
        List<ListGenderResponse> response = objectmapper.readValue(
