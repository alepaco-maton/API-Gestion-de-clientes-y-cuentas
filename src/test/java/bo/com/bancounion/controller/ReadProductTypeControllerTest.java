...
public class ReadProductTypeControllerTest {
    ...
    public ReadProductTypeControllerTest() {
    }
    ...
    public void readSuccessful() throws Exception {
        String jsonResponse = mockMvc
                .perform(
                        MockMvcRequestBuilders.get(
                                ProductTypeController.API_RESOURCE)
        ...
        List<ListProductTypeResponse> response = objectmapper.readValue(
