...
public class DeleteCustomerAccountControllerTest {
    ...
    CreateCustomerAccountResponse customer;

    public DeleteCustomerAccountControllerTest() {
    }
    ...
    public void updateFailIdNotFound() throws Exception {
        ...
        assertEquals(ex.getCode(),
                ErrorCode.DELETE_CUSTOMER_ACCOUNT_CUSTOMER_ID_NOT_FOUND.getCode());
    }
    ...
    public void updateSuccessful() throws Exception {
        int status = mockMvc
                .perform(
                        MockMvcRequestBuilders.delete(
                                CustomerAccountController.API_RESOURCE + "/" + customer.getId())
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().
        ...
        CustomerAccount modelDelete = repository.findByStatusEqualsAndId(
                CustomerAccountStatus.DELETE, customer.getId());
